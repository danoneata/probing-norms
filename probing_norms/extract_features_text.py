...
FEATURE_EXTRACTORS = {
    ...
    "gemma-2b-contextual-last": partial(
        ...
        model_id="google/gemma-2b",
        layer="last",
        context_type="gpt4o_concept_context_sentences",
    ),
    ...
    "gemma-2b-contextual-50-last": partial(
        ...
        model_id="google/gemma-2b",
        layer="last",
        context_type="gpt4o_50_concept_context_sentences",
    ),
    "gemma-2b-contextual-50-constrained-last": partial(
        ...
        model_id="google/gemma-2b",
        layer="last",
        context_type="gpt4o_50_constrained_concept_context_sentences",
    ),
