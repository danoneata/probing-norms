...
def show_results(norms_loader, models, feature, filter, sorter, num_to_show):
    image_names = dict(
        read_file(
    ...
    norms_str = norms_loader.get_suffix()
    feature_to_concepts, _, _ = norms_loader()
    concepts = norms_loader.load_concepts()

    df = pd.read_pickle("output/demo/predictions-{}.pkl".format(norms_str))
...
if __name__ == "__main__":
    ...
    show_results(norms_loader, models, feature, filter, sorter, num_to_show)
